---
title: "Add a command"
description: "Model a real yelp record and expose it as a command, a route, and a tool at once."
weight: 10
---
...
- `kit:"link,kind=<scheme>/<type>"` marks an outbound edge. It can point at
  another yelp type or at another site entirely, which is what lets a
